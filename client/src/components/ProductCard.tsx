      ...
      <div className="group block h-full">
        ...
        >
          <Link href={`/product/${product.id}`} className="block">
            <div className="relative overflow-hidden aspect-[3/4] bg-neutral-900 mb-4 rounded-lg">
              <img
                src={mainImage}
                alt={product.title}
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {showSayMore && (
                  <button
                    ...
                    className="p-1.5 rounded-full bg-white/5 border border-white/10 text-neutral-400 hover:bg-[#C8FF00]/10 hover:text-[#C8FF00] hover:border-[#C8FF00]/20 transition-all opacity-0 group-hover:opacity-100"
